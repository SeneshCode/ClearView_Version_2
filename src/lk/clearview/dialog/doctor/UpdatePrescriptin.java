 ...
 * @author USER
 */
public class UpdatePrescriptin extends javax.swing.JDialog {

    /**
     * Creates new form ScheduleDateTime
     */
    public UpdatePrescriptin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdatePrescriptin dialog = new UpdatePrescriptin(new javax.swing.JFrame(), true);
