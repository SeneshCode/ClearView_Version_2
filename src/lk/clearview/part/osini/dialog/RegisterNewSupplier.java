...
public class RegisterNewSupplier extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Register New Supplier");
        ...
        jButton8.setText("Select Company");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        CompanyRegistration cr = new CompanyRegistration(Dashboard.DASHBOARD, true);
        cr.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterNewSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
