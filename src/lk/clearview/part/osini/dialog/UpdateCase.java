 ...
 * @author acer
 */
public class UpdateCase extends javax.swing.JDialog {

    /**
     * Creates new form UpdateCase
     */
    public UpdateCase(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateCase dialog = new UpdateCase(new javax.swing.JFrame(), true);
