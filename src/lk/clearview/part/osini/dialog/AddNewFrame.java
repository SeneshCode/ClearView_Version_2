 ...
 * @author acer
 */
public class AddNewFrame extends javax.swing.JDialog {

    /**
     * Creates new form AddNewFrame
     */
    public AddNewFrame(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Add New Frame");

        jLabel16.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel16.setText("Add New Frame");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddNewFrame dialog = new AddNewFrame(new javax.swing.JFrame(), true);
